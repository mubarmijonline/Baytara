...
def upgrade():
    ...
    with op.batch_alter_table('instapay_payments', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_instapay_payments_bundle_id_bundles', 'bundles', ['bundle_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('instapay_payments', schema=None) as batch_op:
        batch_op.drop_constraint(_foreign_key_name('instapay_payments', 'bundle_id'), type_='foreignkey')

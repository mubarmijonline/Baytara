const COPY = {
  ar: {
    ...
    videoReports: {
      ...
      events: { denied: 'رفض', provider_failed: 'فشل المزوّد', otp_issued: 'إصدار تصريح المشاهدة', play: 'تشغيل', pause: 'إيقاف مؤقت', resume: 'استئناف', heartbeat: 'نبضة متابعة', ended: 'انتهاء', player_error: 'خطأ المشغّل' },
  ...
  en: {
    ...
    videoReports: {
      ...
      events: { denied: 'Denied', provider_failed: 'Provider failed', otp_issued: 'OTP issued', play: 'Play', pause: 'Pause', resume: 'Resume', heartbeat: 'Heartbeat', ended: 'Ended', player_error: 'Player error' },

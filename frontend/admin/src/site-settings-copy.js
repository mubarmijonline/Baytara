const COPY = {
  ar: {
    ...
    save: 'حفظ الإعدادات', saved: 'تم حفظ الإعدادات.', saveError: 'تعذّر حفظ الإعدادات.', loadError: 'تعذّر تحميل الإعدادات.',
  ...
  en: {
    ...
    save: 'Save settings', saved: 'Settings saved.', saveError: 'Unable to save settings.', loadError: 'Unable to load settings.',
